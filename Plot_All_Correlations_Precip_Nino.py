...
for nino in tqdm(nino_regions):
    ...
    os.chdir(f'/home/luiz/Jupyter_Notebook/Python_Notebook/Climate_Extremes_DOC/Correlations_NC/{nino}/Precip_COR/')
    # Get list of files
    ...
    plt.savefig(f'Correlations-Precip-{nino}.png', dpi=600, bbox_inches='tight', facecolor='white')
