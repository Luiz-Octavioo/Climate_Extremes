...
path = '/home/luiz/Jupyter_Notebook/Python_Notebook/Climate_Extremes_DOC/Scripts_Extremes/PDF-Temp-SA/'
...
# Load datasets
df = pd.read_excel('~/Jupyter_Notebook/Python_Notebook/Climate_Extremes_DOC/mean_temp-SA-PDF.xlsx')
...
# Save figure
fig.savefig(f'{path}SA_Temp.png', bbox_inches='tight', dpi=350)
# plt.show()
