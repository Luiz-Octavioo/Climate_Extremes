...
path = '/home/luiz/Jupyter_Notebook/Python_Notebook/Climate_Extremes_DOC/Scripts_Extremes/PDF-Precip-IPCC/'
...
# Load datasets
df = pd.read_excel('~/Jupyter_Notebook/Python_Notebook/Climate_Extremes_DOC/mean_precip-IPCC-Regions-PDF.xlsx')
# Rename columns
...
for region in regions:
    ...
    fig.delaxes(axs[-1])
    # Save figure
    fig.savefig(f'{path}{region}.png', bbox_inches='tight', dpi=350)
    # plt.show()
